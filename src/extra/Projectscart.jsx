      ...
      <div className="flex mr-14 ml-14 mb-[30px] flex-col">
        <div className="flex justify-between">
          ...
          <div className="links flex gap-3 items-center">
            <div className="bg-black/70 w-7 h-7 text-center p-3 flex justify-center items-center rounded-full hover:bg-red-700 shadow transition-colors duration-500">
              <span className=" cursor-pointer"> {firsticon}</span>
            </div>
            <div className="bg-black/70 w-7 h-7 text-center p-3 flex justify-center items-center rounded-full hover:bg-designcolor shadow transition-colors duration-500">
